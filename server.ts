...
async function startServer() {
  ...
  app.get('/google298a34c1d8297195.html', (req, res) => {
    res.type('text/html').send('google-site-verification: google298a34c1d8297195.html');
  });
  app.get('/google298a34c1d8297195', (req, res) => {
    res.type('text/html').send('google-site-verification: google298a34c1d8297195.html');
  });
