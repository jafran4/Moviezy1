      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-neutral-600 text-sm sm:text-base leading-relaxed">
            Discover why millions trust <strong className="text-neutral-950 font-bold">Tiger OTT</strong> as the ultimate <strong className="text-amber-600 font-bold">IPTV service provider</strong>. Experience seamless 4K Ultra HD playback, zero buffering, over 20,000 live channels, 50,000+ movies, and the cheapest IPTV service plans available online.
          </p>
        </div>

        {/* Feature Highlights Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-14 sm:mb-18">
          <div className="bg-neutral-50 p-5 sm:p-6 rounded-2xl border border-neutral-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
            <div>
          ...
          <div className="bg-neutral-50 p-5 sm:p-6 rounded-2xl border border-neutral-200 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
            <div>
              ...
              <p className="text-xs text-neutral-600 leading-relaxed">
                Stream live sports, international TV networks, news, and 50,000+ VOD blockbuster movies in true 4K &amp; FHD.
              </p>
            </div>
          </div>
        ...
        <div className="bg-neutral-50 rounded-2xl p-6 sm:p-8 lg:p-10 border border-neutral-200 mb-14 sm:mb-18 shadow-xs">
            ...
            <table className="w-full text-left text-xs sm:text-sm">
              ...
              <tbody className="divide-y divide-neutral-200">
                <tr>
                  ...
                  <td className="py-3.5 text-emerald-700 font-black">From $1.65 / mo</td>
            ...
            {faqList.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isOpen && (
                    <div className="px-4 sm:px-5 pb-4 sm:pb-5 pt-1 text-xs sm:text-sm text-neutral-600 leading-relaxed border-t border-neutral-200">
                      <p>{faq.answer}</p>
                    </div>
                  )}
                </div>
