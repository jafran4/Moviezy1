...
const NetflixCard: React.FC<NetflixCardProps> = ({
  ...
  if (isTop10 && typeof rank === "number") {
    return (
      ...
      >
        ...
        {/* Poster Card */}
        <div className="relative w-[115px] sm:w-[155px] md:w-[175px] h-[170px] sm:h-[230px] md:h-[260px] rounded-lg overflow-hidden bg-neutral-100 shadow-md border border-neutral-300 group-hover:border-neutral-500 group-focus:border-amber-500 group-focus:ring-4 group-focus:ring-amber-500/80 group-focus:shadow-[0_0_25px_rgba(245,158,11,0.8)] transition-all">
          <img
            src={posterPath}
            alt={title}
  ...
  return (
    <div
      ...
      onKeyDown={handleKeyDown}
      onClick={() => onOpenDetail(media)}
      className="group relative flex-shrink-0 w-[140px] sm:w-[210px] md:w-[240px] lg:w-[270px] xl:w-[290px] h-[210px] sm:h-[145px] md:h-[165px] lg:h-[185px] xl:h-[200px] rounded-xl overflow-hidden bg-neutral-100 shadow-sm cursor-pointer transition-all duration-250 select-none border border-neutral-200 hover:border-neutral-400 hover:shadow-lg focus:border-amber-500 focus:ring-4 focus:ring-amber-500/90 focus:scale-105 focus:z-40 focus:shadow-[0_0_30px_rgba(245,158,11,0.85)] outline-none active:scale-98"
    >
      {/* Background Poster */}
      <img
        src={backdropPath}
